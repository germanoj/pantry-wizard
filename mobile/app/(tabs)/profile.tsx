...
import { useNotInterested } from "@/src/state/NotInterestedContext";
...
export default function ProfilePage() {
  ...
  const { clearRecipes } = useGeneratedRecipes();
  const { clearNotInterested } = useNotInterested();
      ...
      <View style={[styles.container, { backgroundColor: theme.background }]}>
        ...
        >
          <Card>
            ...
            <WizardBody>
              Make an
              <Link href="/(auth)/register" style={[{ color: theme.accent2 }]}>
                {" "}
                account{" "}
              </Link>
    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        <Card>
          ...
          >
            <WizardBody
              style={[styles.logoutText, { color: theme.textOnSurface }]}
            >
              Log out
            </WizardBody>
          </Pressable>
        ...
        >
          ...
          >
            ...
            >
              ...
              <WizardBody style={{ marginTop: 8, color: theme.textMuted }}>
                If you&apos;d like to exit through the wardrobe this will delete
                your login info until you reactivate your account and return to
                the magic.
              </WizardBody>
